  ...
  <?php if (comments_open()) : ?>
    ...
    <?php else : ?>
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <p><input name="submit" class="btn btn-danger" type="submit" id="submit" value="<?php _e('Inquire Now', 'roots'); ?>"></p>
        <input type="hidden" class="form-control" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" size="22">
